...
CATEGORY_ALIASES = [
    {"god_module", "tangled_state_ownership"},
    {"missing_abstraction", "missing_seam_for_testing"},
    {"wrong_layer_for_concern", "circular_responsibility", "inverted_dependency"},
]
# Architecture findings are file-level / cross-module — line numbers are advisory only.
LINE_TOLERANT_CATEGORIES = {
    "god_module", "missing_abstraction", "wrong_layer_for_concern",
    "leaky_boundary", "circular_responsibility", "missing_seam_for_testing",
    "inverted_dependency", "tangled_state_ownership", "other",
}
