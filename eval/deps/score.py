...
CATEGORY_ALIASES = [
    {"precarious_pre_1_0", "loose_version_range"},
    {"outdated_major", "deprecated_package"},
]

# Dep findings are file-level; line is always null. (file, category) suffices.
LINE_TOLERANT_CATEGORIES = {
    "outdated_major", "precarious_pre_1_0", "loose_version_range",
    "missing_lockfile", "missing_audit", "missing_overrides",
    "unpinned_runtime", "deprecated_package", "unused_dep",
    "precarious_script", "other",
}
