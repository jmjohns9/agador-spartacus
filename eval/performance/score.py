...
CATEGORY_ALIASES = [
    {"hot_loop_allocation", "missing_short_circuit", "excessive_ipc_or_rerender"},
    {"redundant_recomputation", "missing_short_circuit"},
    {"unbounded_buffer", "excessive_ipc_or_rerender"},
]
LINE_TOLERANT_CATEGORIES = {"sequential_await_in_loop", "redundant_recomputation"}
DEFAULT_LINE_WINDOW = 50
