...
CATEGORY_ALIASES = [
    {"magic_constant", "duplicated_logic"},
    {"weak_naming", "stale_comment_or_dead_code", "inconsistent_style"},
    {"module_scope_mutable_state", "type_safety_escape_hatch"},
]
LINE_TOLERANT_CATEGORIES = {
    "silent_error_swallowing", "module_scope_mutable_state",
    "magic_constant", "duplicated_logic", "stale_comment_or_dead_code",
}
DEFAULT_LINE_WINDOW = 100
