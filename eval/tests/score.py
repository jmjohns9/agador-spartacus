...
CATEGORY_ALIASES = [
    {"no_test_infrastructure", "no_ci_test_gate"},
    {"untested_critical_module", "untested_pure_function", "untested_simulator_parity"},
]
LINE_TOLERANT_CATEGORIES = {
    "no_test_infrastructure", "no_ci_test_gate", "untested_critical_module",
    "untested_pure_function", "untested_simulator_parity", "missing_test_type", "other",
}
...
def norm_path(p):
    if not p:
        return p
    # Strip optional leading "files/" so scope-relative and repo-relative match.
