    ...
    <ScrollPane>
      ...
      <Grid cols={4}>
        ...
        <MetricTile
          ...
          valueColor={load > 85 ? 'var(--sa)' : 'var(--tw)'}
      ...
      <Grid cols={4}>
        <MetricTile
          ...
          subtext={`Typical V8 idle: 4–6 g/s · current: ${maf > 0 ? maf + ' g/s' : '—'}`}
