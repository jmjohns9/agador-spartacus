...
import { ScrollPane, SectionHeader, Card, Badge } from './UIComponents';
  ...
  return (
    <div style={{ borderBottom: '1px solid var(--bg3)' }}>
      ...
      >
        ...
        {/* Category badge */}
        <span style={{ fontSize: 9, color: catColor, fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: 0.3, textTransform: 'uppercase', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
      ...
      {expanded && (
        <div style={{ background: 'var(--bg4)', borderTop: '1px solid var(--bg3)', padding: '12px 16px', display: 'grid', gridTemplateColumns: '1fr 220px', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div>
              <div style={{ fontSize: 9, color: 'var(--tm)', fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 3 }}>Range</div>
            ...
            {pid.warnHigh !== undefined && (
              <div>
                <div style={{ fontSize: 9, color: 'var(--tm)', fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 3 }}>Warning threshold</div>
            ...
            <div>
              <div style={{ fontSize: 9, color: 'var(--tm)', fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 3 }}>Live value</div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        {['PID', 'Category', 'Parameter', 'Unit', 'Live value', ''].map(h => (
          <span key={h} style={{ fontSize: 9, color: 'var(--tm)', fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: 0.5, textTransform: 'uppercase' }}>
            {h}
          </span>
        ))}
      </div>
