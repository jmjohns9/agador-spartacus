...
import { useAppStore, selectBatteryVoltage, selectVoltageTrend } from './appStore';
import {
      ...
      <Grid cols={4}>
        <div style={{
          ...
          <ArcGauge
            ...
            min={11.6} max={13.0}
            label="" unit="V" size={90}
            color={voltageColor}
            isDark={isDark}
          />
          <span style={{ fontSize: 11, color: voltageColor, fontFamily: "'Barlow Condensed', sans-serif" }}>
            {voltageLabel}
          </span>
        </div>
