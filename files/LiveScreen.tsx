    ...
    <ScrollPane>
      ...
      <Grid cols={4}>
        ...
        <MetricTile
          ...
          tooltip={<TipContent name="Fuel Tank Level Remaining" description="Fuel level sensor signal from the sender float in the fuel tank. The 2004 Silverado 1500 has a 26-gallon fuel tank." formula="(byte A ÷ 255) × 100" range="Parameter 012F" />}
        />
        <MetricTile
      ...
      <Grid cols={4}>
        ...
        <MetricTile
          ...
          tooltip={<TipContent name="Fuel Rail Gauge Pressure" description="Fuel rail pressure above atmospheric. The 5.3 L Vortec uses a returnless fuel rail controlled by the Engine Control Module." formula="((byte A × 256) + byte B) × 10 kPa → × 0.14504 for psi" range="Parameter 0123 · Spec: 55–60 psi" />}
        />
        <MetricTile
