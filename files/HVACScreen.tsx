          ...
          <div>
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'flex-start', marginBottom: 5 }}>
                <div style={{ width: 16, height: 16, borderRadius: '50%', background: 'var(--bg4)', border: '1px solid var(--br)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 9, color: 'var(--tm)', flexShrink: 0 }}>
                  {i + 1}
                </div>
